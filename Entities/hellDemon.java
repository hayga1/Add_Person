...
public class hellDemon extends NPC {
    BufferedImage img;

    public hellDemon(Vector2 position) {
        super(position, 50, 50, NPCID.HELLDEMON);
        img = getSprite(LoadSave.HELLDEMON_ATLAS);
        type = NPCID.HELLDEMON;
    }
