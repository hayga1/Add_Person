...
public class flyingBlackSnake extends NPC {
    BufferedImage img;

    public flyingBlackSnake(Vector2 position) {
        super(position, 50, 50, NPCID.FLYINGBLACKSNAKE);
        img = getSprite(LoadSave.FLYINGBLACKSNAKE_ATLAS);
        type = NPCID.FLYINGBLACKSNAKE;
    }
